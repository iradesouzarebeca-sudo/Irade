...
private val DarkColorScheme =
  darkColorScheme(
    primary = GeometricPrimaryContainer,
    onPrimary = GeometricOnPrimaryContainer,
    primaryContainer = GeometricPrimary,
    onPrimaryContainer = GeometricOnPrimary,
...
fun MyApplicationTheme(
  ...
  // Disable dynamicColor by default to enforce our custom Geometric Balance branding scheme
